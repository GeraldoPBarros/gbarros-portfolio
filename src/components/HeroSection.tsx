      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <div className="text-xl md:text-2xl text-muted-foreground mb-4 font-light">
            Hi, I'm{" "}
            <span className="text-primary font-semibold">Geraldo Barros</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            a pixel-perfect approach to modern frontend development.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <a href="https://drive.google.com/file/d/1vBJqZdBwjhcugaQOBWCBiETbMu0Wzes_/view?usp=sharing" target="_blank">
              <Button
                variant="ghost"
                size="lg"
